...
public class RunningInstanceInfo extends AbstractInstanceInfo {

	private final String elapsedTime;

	public RunningInstanceInfo(int id, String appName, int port, String servicePort, String dockerInstance,
			String elapsedTime) {
